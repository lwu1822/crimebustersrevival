...
<script>
  ...
  const url = "https://lwu1822.github.io/crimebustersrevival/trivia";
  const get_url = url +"/";
    ...
    .then(response => {
      ...
      response.json().then(data => {
          ...
          for (const row of data) {
            ...
            // td for joke cell
            const trivia = document.createElement("td");
              trivia.innerHTML = row.id + ". " + row.trivia;  // add fetched data to innerHTML
